...
"""
    ...
    python $PATH/App_lsd.py --input=N20150811G0074.m.fits.gz --linesmask=LineMaskForContinuumDetection.txt --wavemask=OrderValidWavelengthRanges.txt --spectype=raw --rvsampling=2.0 --output=N20150811G0074.s.fits -tr
    """
...
try:
    ...
    print "Error: check usage with App_lsd.py -h "; sys.exit(1);
